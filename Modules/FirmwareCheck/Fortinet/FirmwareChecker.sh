...
awk '{ print $2}' ./Devices/Firmware-Versions/Firmware-Versions.txt | cut -d "-" -f2 | sort | uniq -c | sed  's/^ *//' | sed 's/ / x FortiOS /g' > ./Devices/Firmware-Versions/Fortinet-Firmware-Count.txt
